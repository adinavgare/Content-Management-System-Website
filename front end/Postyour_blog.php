...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="/Globalsoft_technology_latest/front end/favicon-16x16.png">
...
<body>
    <nav class="navigation max-width-1 m-auto">
        <div class="nav-left" style="padding-top: 80px;">
            <ul  style="float: left;">
                ...
                <li><a href="contact.php">Post your blog</a></li>
    ...
    <div class="contact-content font1 max-width-1 m-auto">
        <div class="max-width-1 m-auto mx-1">
            <h2>Feel Free to Post your Blog!</h2>
            <?php
if(isset($_POST['submit']))
{
  $image_name = $_FILES['image']['name'];
  $image_tmp = $_FILES['image']['tmp_name'];
  $image_path = "frontend" . $image_name;

  // Move the uploaded image to the includes directory
  move_uploaded_file($image_tmp, $image_path);
    if($_POST['name']=='' or $_POST['number']==''  or $_POST['mail']=='')
    {
    ...
    else
    {
        ...
        $sql = "insert into blog(name, number, mail, image, title, content) values('$name', '$number', '$mail', '$image_name', '$title', '$content')";
...
?>
            ...
            <div class="contact-form">
                ...
                <div class="form-box">
                    <input type="email" placeholder="Enter Your Email Id" name="mail">
                </div>
                <div class="form-box" style="width: 10px;">
                  <label for="image">SelectImage:</label><br>
                  <input type="file" name="image" size="60"
                </div>
                <div class="form-box">
                <textarea name="title" placeholder="Blog Title"></textarea>
<textarea name="content" cols="20" rows="10" style="height: 150px;" placeholder="Enter your blog"></textarea>
